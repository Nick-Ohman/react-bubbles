...
Used to grant access to authorization required pages.
- [ ] What steps can you take in your web apps to keep your data secure?
Have a good authentication system and require strong passwords.
- [ ] Describe how web servers work.
Servers take in user interactions and responds according to those requests/interactions.
